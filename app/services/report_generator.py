...
class ReportGenerator:
    def __init__(self):
        """
        Render NO permite escribir archivos dentro del proyecto.
        Por eso usamos un directorio temporal seguro.
        """
        # Crear carpeta temporal para reportes
        self.reports_dir = tempfile.mkdtemp(prefix="reports_")
